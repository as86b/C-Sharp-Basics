...
namespace CSharpBasics
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //Compare sample1 to sample2 and if they are equal display “The samples are equal.” otherwise display 
            ...
            //Using the character constant integral, display the character in 
            //integral followed by the string “ is an integral.”
